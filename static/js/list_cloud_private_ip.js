$(document).ready(async function(){
    let retrieveModelData = await retrieveModel(`http://192.168.49.2:31471/api/v1/cloud-private-ips?page=1`)
    ...
    paginationLoad(retrieveModelData["total_pages"], `http://192.168.49.2:31471/api/v1/cloud-private-ips?page=`)
    ...
    $("#delete-btn").click(function () {
        delete_data("http://192.168.49.2:31471/api/v1/cloud-private-ips?cloud_private_ip_id="+list.toString(),
            'http://192.168.49.2:31471/network-management-solutions/list/cloud-private-ips');
    })
    ...
    $('#modalCloudPrivateIP').on('show.bs.modal', async function() {
        ...
        console.log(dataId)
        let cloudPrivateIpResponse = await fetch('http://192.168.49.2:31471/api/v1/cloud-private-ips?cloud_private_ip_id=' + dataId);
        ...
        update_button.click(async function(){
            ...
            await patchModel(
                ...
                "http://192.168.49.2:31471/api/v1/cloud-private-ips?cloud_private_ip_id="+dataId,
                'http://192.168.49.2:31471/api/v1/cloud-private-ips?page='
            )
        });
    });
