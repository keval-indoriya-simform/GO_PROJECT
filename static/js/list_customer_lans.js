$(document).ready(async function(){
    let retrieveModelData = await retrieveModel(`http://192.168.49.2:31471/api/v1/customer-lans?page=1`)
    ...
    paginationLoad(retrieveModelData["total_pages"], `http://192.168.49.2:31471/api/v1/customer-lans?page=`)
    ...
    $("#delete-btn").click(function () {
            delete_data("http://192.168.49.2:31471/api/v1/customer-lans?customer_lan_id="+list.toString(),
                `http://192.168.49.2:31471/network-management-solutions/list/customer-lans`)
    })

    $('#modalCustomerLan').on('show.bs.modal', async function() {
        var dataId = $(this).attr("data-id");
        let customerLanResponse = await fetch('http://192.168.49.2:31471/api/v1/customer-lans?' +
        ...
        const cloudPrivateIpResponse = await fetch('http://192.168.49.2:31471/api/v1/cloud-private-ips?' +
        ...
        update_button.click(async function(){
            ...
            await patchModel(
                ...
                "http://192.168.49.2:31471/api/v1/customer-lans?customer_lan_id=" + dataId,
                `http://192.168.49.2:31471/api/v1/customer-lans?page=`
            )
        });
    });
