...
$(document).ready(async function() {
    const customerResponse = await fetch('http://localhost:8080/api/v1/customer-locations?select_column=customer_locations.customer_location_id,customer_locations.name&set_limit=false');
    ...
    create_button.click(async function(){
        ...
        await postModel(
            ...
            "http://localhost:8080/api/v1/installed-firewalls"
        )
    });
});
