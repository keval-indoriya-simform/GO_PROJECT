$(document).ready(async function(){
    let retrieveModelData = await retrieveModel(`http://192.168.49.2:31471/api/v1/installed-firewalls?select_column=installed_firewalls.installed_firewall_id&append_select=true&page=1`)
    ...
    paginationLoad(retrieveModelData["total_pages"], `http://192.168.49.2:31471/api/v1/installed-firewalls?select_column=installed_firewalls.installed_firewall_id&append_select=true&page=`)
    ...
    $("#delete-btn").click(function () {
        delete_data("http://192.168.49.2:31471/api/v1/installed-firewalls?installed_firewall_id="+list.toString(),
            `http://192.168.49.2:31471/network-management-solutions/list/installed-firewalls`)
    })

    $('#modalInstalledFirewall').on('show.bs.modal', async function() {
        let dataId = $("#modalInstalledFirewall").attr("data-id");
        console.log(dataId)
        let installedFirewallResponse = await fetch('http://192.168.49.2:31471/api/v1/installed-firewalls/?select_column=installed_firewalls.installed_firewall_id,wan_configs1_ipv4.ip_range&append_select=true&installed_firewall_id=' + dataId);
        ...
        update_button.click(function(){
            ...
            patchModel(
                ...
                "http://192.168.49.2:31471/api/v1/installed-firewalls?installed_firewall_id="+dataId,
                `http://192.168.49.2:31471/api/v1/installed-firewalls?select_column=installed_firewalls.installed_firewall_id&append_select=true&page=`
            )
        });
