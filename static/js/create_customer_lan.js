$(document).ready(async function() {
    ...
    const cloudPrivateIpResponse = await fetch('http://192.168.49.2:31471/api/v1/cloud-private-ips?select_column=cloud_private_ips.cloud_private_ip_id,cloud_private_ips.ipv4_assignment&set_limit=false');
    ...
    submit_button.click(async function(){
        ...
        await postModel(
            ...
            "http://192.168.49.2:31471/api/v1/customer-lans"
        )
    });
