...
type CreateCloudPrivateIp struct {
...
type CreateCloudPublicIp struct {
...
type CreateCustomerLocation struct {
...
type CreateInstalledFirewall struct {
	CustomerLocationID     int32      `json:"customer_location_id,omitempty"`
...
type CreateInternetProvider struct {
	Name         string `gorm:"type:varchar" json:"name,omitempty"`
